...
class Table(Base):
    ...
    status = Column(SAEnum(TableStatus, name="tablestatus", create_type=False, values_callable=lambda x: [e.value for e in x]), nullable=False, default=TableStatus.AVAILABLE)
